        ...
        <div class="md-layout-item">
          <div class="image-wrapper">
            <div class="brand">
              ...
              <h1 class="shopmain">Shopping Cart</h1>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div class="p-5">
                    ...
                    >
                      ...
                      <div class="col-md-3 col-lg-3 col-xl-3">
                        <h6 class="text-muted">Chair</h6>
                        <h6 class="text-black mb-0">Paloma Lounge</h6>
                      </div>
                    ...
                    >
                      ...
                      <div class="col-md-3 col-lg-3 col-xl-3">
                        <h6 class="text-muted">Chair</h6>
                        <h6 class="text-black mb-0">DNA Lounge Chair</h6>
                      </div>
                      <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                        <button
                          class="btn btn-link px-2"
                    ...
                    >
                      ...
                      <div class="col-md-3 col-lg-3 col-xl-3">
                        <h6 class="text-muted">Chair</h6>
                        <h6 class="text-black mb-0">Delphi Work Chair</h6>
                      </div>
                      <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                        <button
                          class="btn btn-link px-2"
